...
class NoteTestCase(TestCase):
    ...
    Проверяет, что пользователи могут создавать заметки, редактировать и удалять свои заметки,
    а также проверяет ограничения для анонимных пользователей и пользователей, не являющихся авторами заметок.
    """
    def setUp(self):
        """
